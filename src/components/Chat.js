  ...
  return (
    <div className="flex flex-col h-screen">
      <header className="flex items-center justify-between space-x-5 border-b border-gray-800 p-4 -mt-1">
        ...
        <button className="bg-green-400 hover:bg-green-600 text-white font-bold py-1 px-1 rounded text-sx">
  Add Friend
</button>
      </header>
      <div className="flex bg-[#202225] text-xs p-2 rounded-lg ">
            <input
              type="text"
              placeholder="Search"
              className="bg-[#202225] focus:outline-none text-white pl-1 placeholder-[#72767d] "
            />
            <SearchIcon className="h-4 text-[#72767d] mr-2 justify-center" />
          </div>
